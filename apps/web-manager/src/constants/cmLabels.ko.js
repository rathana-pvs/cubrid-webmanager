...
export const CM_KO = {
  ...
  killParamResolveErrorMsg: '선택한 트랜잭션에 대한 종료 매개변수를 확인할 수 없습니다.',
  ...
  pagesPerExtensionDesc: '확장 시 추가할 페이지 수',
  ...
  pagesPerExtensionSuffix: '확장당 페이지 수',
  wizardGeneral: '일반 정보',
  ...
  volumePathBackupDirRequiredMsg: '볼륨 경로와 백업 디렉터리는 필수 입력 항목입니다.',
  ...
  configPatchRejectedMsg: '시스템 컨트롤러가 구성 패치를 거부했습니다.',
  connectionNavLabel: '연결',
  serverNavLabel: '서버',
  generalParamsTab: '일반 매개변수',
  advancedParamsTab: '고급 매개변수',
  kernelParamsTitle: '커널 매개변수',
  registrySubtitle: (db) => `${db} · 레지스트리`,
  brokerCharsetConfigDesc: '이 데이터베이스의 브로커 및 문자셋 구성',
  deepSystemConfigDesc: 'CUBRID 인스턴스의 심층 시스템 구성',
  ...
  advancedParamsWarning: '고급 매개변수 — 변경하면 서버 안정성과 성능에 영향을 줄 수 있습니다. 값을 수정할 때 주의하세요.',
  ...
  fullSpectrumPreset: '전체 선택',
  resetGridPreset: '전체 해제',
  standardWeekPreset: '평일 패턴',
  weekendCyclePreset: '주말 패턴',
  dailySyncInfoBanner: (time) => `매일 정확히 ${time}에 동기화됩니다.`,
  registryDate: '등록일',
  ...
  registryPurged: '질의 자동화 계획 삭제됨',
  queryPlanRemovedMsg: '질의 자동화 계획이 삭제되었습니다.',
  deletionFailed: '삭제 실패',
  signalRejected: '삭제 실패',
  deletionSignalFailed: '질의 자동화 계획 삭제에 실패했습니다.',
  retryDeletion: '삭제 재시도',
  dangerousDiscardQueryPlan: '질의 자동화 계획 삭제',
  permanentRemovalSql: 'SQL 자동화 계획 항목을 삭제합니다',
  discardingAutomationHandleMsg: (id) => `자동화 핸들 "${id}"을(를) 삭제하는 중입니다.`,
  logsNotPurgedNotice: '이 계획으로 생성된 기존 로그는 삭제되지 않지만, 새로운 실행은 예약되지 않습니다.',
  executeDiscard: '삭제',
  discardQueryStrategy: '질의 자동화 계획을 삭제하시겠습니까?',
  planRetirement: '질의 자동화 계획 삭제',
  ...
  extractionProfileDesc: '추출 프로필은 데이터베이스 메모리 힙에서 현재 활성화된 매개변수의 스냅샷을 캡처합니다. 하드웨어에 맞춘 운영 지표에 대한 가시성을 제공합니다.',
  ...
  patchRejectedMsg: '시스템 컨트롤러가 패치를 거부했습니다. 스키마 무결성을 확인하세요.',
  ...
  discardBackupStrategy: '백업 자동화 계획을 삭제하시겠습니까?',
  backupScheduleNote: '이 작업은 스케줄만 삭제합니다. 디스크의 기존 백업 파일은 유지됩니다.',
  dangerousDiscardBackupPlan: '백업 자동화 계획 삭제',
  permanentRemovalBackup: '백업 자동화 계획을 영구 삭제합니다',
  deletionSignalRejectedMsg: '시스템 컨트롤러가 삭제 신호를 거부했습니다. 레지스트리가 계속 활성 상태입니다.',
  ...
  deleteGroupConfirmDesc: '그룹과 그 안의 모든 호스트 연결이 제거됩니다.',
  ...
  irreversibleActionNotice: '이 작업은 되돌릴 수 없으며 취소할 수 없습니다.',
  ...
  exportHostsDesc: '호스트를 XML 파일로 내보냅니다. 참고: 비밀번호는 포함되지 않습니다.',
  importHostsDesc: '단일 그룹으로 호스트 목록을 가져옵니다 (레거시 XML / .prefs / .properties).',
  changeFileBtn: '파일 변경',
  ...
  importFormatHelp: 'CUBRID 호스트 XML 또는 레거시 데스크톱 .prefs / .properties(CUBRID_SERVERS 및 호스트 그룹) 파일입니다. .prefs의 암호화된 비밀번호는 가져오지 않습니다.',
  ...
  synchronizingDataTitle: '데이터 동기화 중',
  fetchingMetricsSubtitle: '인스턴스에서 실시간 지표를 가져오는 중...',
